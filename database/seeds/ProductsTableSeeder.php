...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Product::create([
            ...
            'slug' => 'MOR Marshmallow Spray 100 ml',
        ...
        Product::create([
            ...
            'category_id' => $perfume->id,
            'slug' => 'DELAROM Homme Perfume 50 ml',
        ...
        Product::create([
            ...
            'category_id' => $perfume->id,
            'slug' => 'Paul Smith London Perfume 100 ml',
            'details' => '5.5 x 9 x 12.7 cm',
            'price' => 38.70,
